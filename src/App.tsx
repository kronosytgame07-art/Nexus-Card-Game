...
function Profile() {
  ...
  const avatarCards = ALL_CARDS.filter((card) => card.type === 'unit' && card.level === 1 && s.unlockedFactions.includes(card.faction))
    .concat(purchasableAvatarCards(s.unlockedFactions).filter((card) => s.purchasedAvatars.includes(card.id)));
  ...
  return (
    <section>
      ...
      <div className="avatar-grid">
        {purchasableAvatarCards(s.unlockedFactions).map((card) => {
