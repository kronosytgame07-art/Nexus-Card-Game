...
import ProceduralArenaBackground from './components/ProceduralArenaBackground';
          ...
          return (
            <article key={terrain.id} className={'terrain-card' + (active ? ' active' : '')}>
              <div className="terrain-preview">
                {terrain.id === 'default' ? <ArenaBackground className="terrain-preview-bg" /> : <ProceduralArenaBackground theme={terrain.id} className="terrain-preview-bg" />}
              </div>
              <b>{terrain.name}</b>
...
function Replay() {
  ...
  return <section className="battle">
    {s.selectedTerrain === 'default' ? <ArenaBackground className="battle-bg-video" paused={false} /> : <ProceduralArenaBackground theme={s.selectedTerrain} className="battle-bg-video" paused={false} />}
