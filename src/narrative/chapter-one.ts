...
export const CHAPTER_ONE: StoryDuel[] = [
  {
    ...
    lines: [
      ...
      { speaker: 'lyra', text: 'Retire ta main de cette pierre. Qui t’a envoyé ?', panel: panel('scene-02-lyra-warning'), speakerSide: 'left', emotion: 'Méfiance', portraitEmotion:'angry', cinematic:{camera:'pan-right',atmosphere:'mist',intensity:1}, choices: [
      ...
      { speaker: 'lyra', text: 'Alors montre-moi ce que ce fragment t’a appris.', panel: panel('scene-03-lyra-challenge'), speakerSide: 'left', emotion: 'Défi', portraitEmotion:'angry', cinematic:{camera:'push',atmosphere:'mist',intensity:2} },
    ],
  },
  {
    id: 1,
    ...
    lines: [
      { speaker: 'kael', text: 'Croc-de-Lune affirme que tu peux manipuler une Évosphère.', panel: panel('scene-04-kael-interrogation'), speakerSide: 'right', emotion: 'Interrogatoire', portraitEmotion:'neutral', cinematic:{camera:'pan-left',atmosphere:'none',intensity:1} },
      { speaker: 'lyra', text: 'Je n’ai pas dit que je comprenais comment.', panel: panel('scene-05-lyra-doubt'), speakerSide: 'left', emotion: 'Scepticisme', portraitEmotion:'worried', cinematic:{camera:'pull',atmosphere:'mist',intensity:1} },
      { speaker: 'kael', text: 'Dans ce cas, prouvons ce que tu es.', panel: panel('scene-06-kael-challenge'), speakerSide: 'right', emotion: 'Résolution', portraitEmotion:'angry', cinematic:{camera:'push',atmosphere:'none',intensity:2,flash:true} },
    ],
  },
  {
    id: 2,
    ...
    lines: [
      { speaker: 'gribz', text: 'PERSONNE NE BOUGE ! … C’était pas cette salle.', panel: panel('scene-07-gribz-wrong-room'), speakerSide: 'left', emotion: 'Entrée explosive', portraitEmotion:'surprised', cinematic:{camera:'push',atmosphere:'embers',intensity:2,shake:true,flash:true} },
      { speaker: 'kael', text: 'Vous avez fait exploser les Archives.', panel: panel('scene-08-kael-accuses'), speakerSide: 'right', emotion: 'Incrédulité', portraitEmotion:'surprised', cinematic:{camera:'pan-left',atmosphere:'embers',intensity:1} },
      { speaker: 'gribz', text: 'Techniquement, elles étaient déjà très archivées.', panel: panel('scene-09-gribz-shrug'), speakerSide: 'left', emotion: 'Aucun remords', portraitEmotion:'smile', cinematic:{camera:'pull',atmosphere:'embers',intensity:1} },
    ],
  },
  {
    id: 3,
